...
- 知识引用：K-13, K-17
- 引导引用：guidance/action-designer.md#任务1
- 限制引用：restrictions.md#方案效力
- 评估引用：evaluation.md#S1
- 脚手架引用：scaffolds/action-designer.md#任务1
- 常见误区：写“提高大家意识”但无法观察
- 最大尝试：3
...
- 知识引用：K-12, K-16
- 引导引用：guidance/action-designer.md#任务2
- 限制引用：restrictions.md#风险排序
- 评估引用：evaluation.md#E5
- 脚手架引用：scaffolds/action-designer.md#任务2
- 常见误区：平均分配以回避优先级
- 最大尝试：3
...
- 知识引用：K-13, K-17, K-19
- 引导引用：guidance/action-designer.md#任务3
- 限制引用：restrictions.md#表达与决策
- 评估引用：evaluation.md#E5
- 脚手架引用：scaffolds/action-designer.md#任务3
