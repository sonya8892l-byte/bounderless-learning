...
- 知识引用：K-01, K-23, K-24
- 引导引用：guidance/identity-observer.md#任务1
- 限制引用：restrictions.md#观察优先
- 评估引用：evaluation.md#E1
- 脚手架引用：scaffolds/identity-observer.md#任务1
...
- 知识引用：K-01
- 引导引用：guidance/identity-observer.md#任务2
- 限制引用：restrictions.md#事实与角色表达
- 评估引用：evaluation.md#S1
- 脚手架引用：scaffolds/identity-observer.md#任务2
...
- 引导引用：guidance/identity-observer.md#任务2
- 限制引用：restrictions.md#事实与角色表达
- 评估引用：evaluation.md#K1, evaluation.md#C1
- 脚手架引用：scaffolds/identity-observer.md#任务2
- 常见误区：把推断写成确定事实
- 最大尝试：3
...
- 知识引用：K-20
- 引导引用：guidance/identity-observer.md#任务3
- 限制引用：restrictions.md#物种动态信息
- 评估引用：evaluation.md#K1, evaluation.md#S1
- 脚手架引用：scaffolds/identity-observer.md#任务3
- 常见误区：为填满字段而猜学名
- 最大尝试：2
