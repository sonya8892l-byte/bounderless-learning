...
- 知识引用：K-02, K-24
- 引导引用：guidance/label-recorder.md#任务1
- 限制引用：restrictions.md#场馆与隐私
- 评估引用：evaluation.md#E1, evaluation.md#E4
- 脚手架引用：scaffolds/label-recorder.md#任务1
...
- 知识引用：K-02
- 引导引用：guidance/label-recorder.md#任务2
- 限制引用：restrictions.md#事实与角色表达
- 评估引用：evaluation.md#K1, evaluation.md#S1
- 脚手架引用：scaffolds/label-recorder.md#任务2
...
- 知识引用：K-02, K-22
- 引导引用：guidance/label-recorder.md#任务3
- 限制引用：restrictions.md#物种动态信息
- 评估引用：evaluation.md#S1, evaluation.md#C4
- 脚手架引用：scaffolds/label-recorder.md#任务3
- 常见误区：只写“百度”“AI说”
- 最大尝试：2
- 失败处理：要求写清具体展签或知识卡编号
- 教师介入：来源无法追溯
