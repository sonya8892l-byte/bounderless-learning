...
- 知识引用：K-11, K-12, K-15
- 引导引用：guidance/ecology-mapper.md#任务1
- 限制引用：restrictions.md#观察优先
- 评估引用：evaluation.md#K2, evaluation.md#S1
- 脚手架引用：scaffolds/ecology-mapper.md#任务1
...
- 评估引用：evaluation.md#K2, evaluation.md#C2
- 脚手架引用：scaffolds/ecology-mapper.md#任务1
...
- 知识引用：K-11, K-12, K-13
- 引导引用：guidance/ecology-mapper.md#任务2
- 限制引用：restrictions.md#事实与角色表达
- 评估引用：evaluation.md#K2, evaluation.md#S2
- 脚手架引用：scaffolds/ecology-mapper.md#任务2
- 常见误区：箭头没有方向说明
- 最大尝试：3
...
- 知识引用：K-12, K-16
- 引导引用：guidance/ecology-mapper.md#任务3
- 限制引用：restrictions.md#发布边界
- 评估引用：evaluation.md#C2
- 脚手架引用：scaffolds/ecology-mapper.md#任务3
- 常见误区：措施与威胁无关
- 最大尝试：3
