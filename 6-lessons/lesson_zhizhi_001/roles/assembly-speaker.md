...
- 知识引用：K-21
- 引导引用：guidance/assembly-speaker.md#任务1
- 限制引用：restrictions.md#发布边界
- 评估引用：evaluation.md#S4, evaluation.md#C1
- 脚手架引用：scaffolds/assembly-speaker.md#任务1
- 常见误区：用“大家都知道”代替证据
- 最大尝试：3
- 失败处理：追问证据编号或待核边界
- 教师介入：核心判断与小组证据冲突
...
- 知识引用：K-21, K-22
- 引导引用：guidance/assembly-speaker.md#任务2
- 限制引用：restrictions.md#发布边界
- 评估引用：evaluation.md#S3, evaluation.md#S4
- 脚手架引用：scaffolds/assembly-speaker.md#任务2
...
- 知识引用：K-17, K-18
- 引导引用：guidance/assembly-speaker.md#任务3
- 限制引用：restrictions.md#场馆与隐私
- 评估引用：evaluation.md#C3
- 脚手架引用：scaffolds/assembly-speaker.md#任务3
- 常见误区：写“以后保护动物”
- 最大尝试：3
- 失败处理：追问具体动作和时间
