...
##### 验收标准
至少2张照片；全景能够确认展项类型，局部保留标题、用途、回忆来源或时间中的至少一项；不识别其他参观者身份
- S3 史料实证 — 所有关键结论标注证据类型与来源
- C5 多视角同理 — 同时呈现指挥层与基层行动者的信息条件
...
##### 验收标准
6张卡全部分类；“基层可以确认”和“当时无法知道”各至少2张；不能用全局战图替基层补信息
...
##### 验收标准
完成命令卡查看；不得使用全局战图补出卡片中没有的行动原因和后续路线
...
- 知识引用：K-19
- 限制引用：course.md#课程限制规则/教学限制, course.md#课程限制规则/安全限制
...
##### 验收标准
五项均完成；命令卡没有写明的字段标“缺失/需确认”；至少1项明确不能自行猜测
- S4 信息差分析 — 能指出至少一个敌我判断不对称及其行动影响
...
##### 验收标准
录音不少于20秒、不超过45秒；包含四类信息；不得添加命令卡中没有的历史人物原话
...
##### 验收标准
至少2条组内记录；包含1条一致项和1条差异或待确认项；关键地点、时间或对象有差异时标记“暂停并确认”
- C4 民主与担当 — 能讨论少数意见如何被听见、复核并形成共同执行
- C5 多视角同理 — 同时呈现指挥层与基层行动者的信息条件
...
##### 验收标准
80至150字；至少引用任务1展项证据和任务2命令卡各1条；不生成真实历史人物直接引语、姓名或心理活动
- S3 史料实证 — 所有关键结论标注证据类型与来源
- S6 因果表达 — 使用“证据—判断—行动—结果—修正”完整表达
- C5 多视角同理 — 同时呈现指挥层与基层行动者的信息条件
...
##### 验收标准
6张卡全部放置；史料依据、合理推断和未知三个区域均至少使用一次；未使用卡明确归档
- S3 史料实证 — 所有关键结论标注证据类型与来源
- C3 证据边界 — 清楚标记史实、推断、未知和课程情境
- C5 多视角同理 — 同时呈现指挥层与基层行动者的信息条件
