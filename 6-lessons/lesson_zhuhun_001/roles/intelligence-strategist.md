...
##### 验收标准
至少2张照片；全景能确认展项类型，局部能辨认标题、日期、通信主体或说明文字中的至少一项；不得依据模糊字迹补写
...
##### 验收标准
5个字段均完成，其中至少3项来自照片中可辨认的信息；“未知”允许作为有效记录，禁止补造原句或编号
- S3 史料实证 — 所有关键结论标注证据类型与来源
- C3 证据边界 — 清楚标记史实、推断、未知和课程情境
...
##### 验收标准
5张卡全部完成分类，四个象限均有记录；“敌方可能已知”保持可能性表述
...
##### 验收标准
5张卡均有可靠度；至少1张卡保留低或中可靠度；低可靠度信息填写可执行的核验办法
- S3 史料实证 — 所有关键结论标注证据类型与来源
- S4 信息差分析 — 能指出至少一个敌我判断不对称及其行动影响
- C3 证据边界 — 清楚标记史实、推断、未知和课程情境
...
##### 验收标准
完成2轮且选择不同反应；运行记录保留每轮判断及公开反馈，模拟结果不得作为史实证据
- S4 信息差分析 — 能指出至少一个敌我判断不对称及其行动影响
- S5 决策矩阵 — 同时比较目标、收益、风险、信息可靠度和可逆性
...
##### 验收标准
判断A和判断B各有至少1条依据；窗口、失败风险和失效信息均完成；表述使用“可能、如果、在……条件下”
- S4 信息差分析 — 能指出至少一个敌我判断不对称及其行动影响
- S5 决策矩阵 — 同时比较目标、收益、风险、信息可靠度和可逆性
- C2 战略思维 — 能区分局部战斗和整体脱困目标，并预测二阶反应
