...
- 知识引用：K-12, K-13, K-14
- 引导引用：guidance/comparative-researcher.md#任务1
- 限制引用：restrictions.md#域外结论
- 评估引用：evaluation.md#S1
- 脚手架引用：scaffolds/comparative-researcher.md#任务1
...
- 知识引用：K-12, K-13, K-14
- 引导引用：guidance/comparative-researcher.md#任务2
- 限制引用：restrictions.md#域外结论
- 评估引用：evaluation.md#E3
- 脚手架引用：scaffolds/comparative-researcher.md#任务2
- 常见误区：摘录脱离适用条件
- 最大尝试：3
...
- 知识引用：K-16, K-19
- 引导引用：guidance/comparative-researcher.md#任务3
- 限制引用：restrictions.md#法律效力
- 评估引用：evaluation.md#E3, evaluation.md#E5
- 脚手架引用：scaffolds/comparative-researcher.md#任务3
- 常见误区：只写“值得借鉴”
- 最大尝试：3
- 失败处理：提示补本地责任主体和资源条件
- 教师介入：涉及本地正式权限判断
