...
##### 验收标准
七项比较字段齐全，并明确原文摘录、学生译文、关键词保留和双人复核的记录方式。
...
##### 验收标准
至少9条摘录覆盖三座城市；每条均有官方原文位置、学生译文、所属字段和复核人。
...
##### 验收标准
七项字段在三城均有记录或明确标注“不适用/未找到”，并写出至少3条异同及2条不可直接比较之处。
...
##### 验收标准
3项候选做法均回答问题相似性、主体权限、技术成本条件和试点/例外四问，并引用域外原文与本地证据编号。
...
##### 验收标准
比较报告含至少3项可借鉴建议、1项不宜直接移植内容和1项待核问题，三类判断均能回到来源记录。
